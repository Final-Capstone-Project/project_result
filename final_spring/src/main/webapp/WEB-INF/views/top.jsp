...
<html>
	<head>
		...
		<link rel="stylesheet" href="http://localhost:8001/spring/resources/static/css/bootstrap.css"> <!--bootstrap.css를 이용해서 스타일을 꾸미겠다는-->
		<link rel="stylesheet" href="http://localhost:8001/spring/resources/static/css/MotionDetection.css">
	</head>
	<body> <!--점보트론은 부트스트랩에서 홈페이지를 소개하는 메인 전광판을 의미-->
